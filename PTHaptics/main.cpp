...
*	Description: An application produced for the Physical Therapy
*				 department at the University of Scranton. It is used in
*				 a study to test the merits of haptics technology as a 				 				 
*				 treatment technique.
*				 This application tasks a user with practicing writing
*				 to recover from carpal tunnel syndrome surgery. The user
*				 manipulates the haptics device which is like a robotic arm
*				 holding a pen. A haptics device provides physical feedback 
